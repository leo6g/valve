...
//		var imagePath = $("#edit-imagePath").val();
//		imagePath.replace("100px","380px");
//		$("#edit-preview").html(imagePath);
		$("#edit-imagePath").val("");
	...
	//局部绑定回车事件
	 $("#queryCity").bind('keyup',function(event){
	...
	//实例化一个plupload上传对象
	var editNetPointUploader = new plupload.Uploader({ //实例化一个plupload上传对象
...
////当上传队列中所有文件都上传完成后触发
	//editUploader.bind('UploadComplete',function(uploader,files){
////		console.log(files);
//		alert("上传成功!");
